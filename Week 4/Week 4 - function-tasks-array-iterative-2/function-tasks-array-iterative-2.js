const students = [
  ...
  console.groupCollapsed('1. Atspausdinti visus Informatikos fakulteto studentus');
  {
    ...
    const studentsIT = students.filter(item => item.faculty === 'Informatikos fakultetas');

    console.log({ studentsIT });
  ...
  {
     const studentsChem = students.filter(item => item.faculty === 'Chemijos fakultetas');

    console.log({ studentsChem });
  ...
  {
    const studentsEngineer = students.filter(item => item.faculty === 'Elektros ir elektronikos fakultetas');

    console.log({ studentsEngineer });
  }
  console.groupEnd();
  
  console.groupCollapsed('4. Atspausdinti tik pirmo kurso studentus');
  {
    const freshersStudents = students.filter(item => item.course === 1);

    console.log({ freshersStudents });
  }
  console.groupEnd();
  
  console.groupCollapsed('5. Atspausdinti tik antro kurso studentus');
  {
    const sophomoreStudents = students.filter(item => item.course === 2);

    console.log({ sophomoreStudents });
  }
  console.groupEnd();
  
  console.groupCollapsed('6. Atspausdinti tik trečio kurso studentus');
  {
    const seniorStudents = students.filter(item => item.course === 3);
  ...
  {
    const filteredStudents = students.filter(item => item.course === 4);
  ...
  console.groupCollapsed('8. Iš students masyvo atrinkti ir atspausdinti visų studentų vidurkius');
  {
    students.forEach((student) => {
        ...
        console.log(`%c${student.name} ${student.surname}`, 'color: red;', `---Average---> ${sum / marks}`);
    });
   }
